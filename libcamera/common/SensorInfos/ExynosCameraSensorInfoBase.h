...
public:
    ...
    */
    ...
    rational *colorTransformMatrix1;
    rational *colorTransformMatrix2;
    rational *forwardMatrix1;
    rational *forwardMatrix2;
    rational *calibration1;
    rational *calibration2;
