...
public:
    ...
    ExynosCameraMCPipe(
        ...
        bool isReprocessing,
        camera_device_info_t *deviceInfo) : ExynosCameraPipeFlite(cameraId, obj_param, isReprocessing, NULL)
    {
        m_init(deviceInfo);
    }
    ...
    virtual status_t        flushInputFrameQ(void);
    virtual status_t        flushRequestFrameQ(void);
...
protected:
    ...
    virtual status_t        m_updateMetadataFromFrame(ExynosCameraFrameSP_sptr_t frame, ExynosCameraBuffer *buffer);
    virtual status_t        m_updateMetadataFromFrame_v2(ExynosCameraFrameSP_sptr_t frame, ExynosCameraBuffer *buffer);
    ...
    virtual status_t        m_resetInputs();
